# Transcriptome R environment check -----------------------------------------
...
cran_packages <- c("tidyverse", "pheatmap", "ggrepel", "RColorBrewer", "openxlsx")
bioc_packages <- c(
  "DESeq2",
  "edgeR",
  "limma",
...
write.csv(install_plan, "data/transcriptome_install_plan.csv", row.names = FALSE)

packages_to_check <- c("BiocManager", cran_packages, bioc_packages)
...
write.csv(package_status, "results/transcriptome_package_status.csv", row.names = FALSE)
...
write.csv(env_info, "results/transcriptome_env_info.csv", row.names = FALSE)

cat("\n--- Transcriptome package install plan ---\n")
print(install_plan)
...
cat("\nFiles written:\n")
cat("- data/transcriptome_install_plan.csv\n")
cat("- results/transcriptome_package_status.csv\n")
cat("- results/transcriptome_env_info.csv\n")
